		...
		<div id="cc" class="easyui-layout" fit="true">   
		    ...
		    <div data-options="region:'west',title:'导航菜单',iconCls:'icon-save',split:false" style="width:150px;">
		    	<ul class="easyui-tree" fit="true" id="nav">
		          	...
		          	<p><a href="#" url="userPublicNumber.jsp">公众号跟用户绑定信息管理</a></p>
		          	<p><a href="#" url="publicNumberCheck.jsp">公众号审批信息管理</a></p>
		          	<p><a href="#" url="template.jsp">内容模板信息管理</a></p>
		          	<p><a href="#" url="publicNumberTemplate.jsp">公众号模板绑定信息管理</a></p>
		          	<p><a href="#" url="infoContent.jsp">信息内容管理</a></p>
		          	<p><a href="#" url="infoContentCheck.jsp">信息内容审核管理</a></p>
		          	<p><a href="#" url="publicNumberFans.jsp">公众号粉丝管理</a></p>
	          	</ul>
		    </div>   
