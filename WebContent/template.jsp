		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td>
						<select id="cc" class="easyui-combobox" name="type" style="width:150px" data-options="required:true,editable:false">   
							<option>图片</option>
				    		<option>文字</option>  
				    		<option>图文混合</option>
						</select>
				...
				<!-- <tr>
					...
					<td><input type="text" name="userid" class="easyui-textbox" data-options="required:true,editable:false"></td>
				</tr> -->
				<tr>
					<td class="right">创建人：</td>
					<td>
