	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"name",title:"用户编号",width:100,align:"center"},
				{field:"public_name",title:"公众号编号",width:100,align:"center"}
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				<!-- <tr>
					...
					<td><input id="uid" type="text" name="userid" class="easyui-textbox" data-options="required:true"></td>
				</tr> -->
				<tr>
					<td class="right">用户编号：</td>
					<td>
