	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"pname",title:"公众号",width:100,align:"center"},
				{field:"addFans",title:"新增粉丝数",width:100,align:"center"},
				{field:"reduceFans",title:"减少粉丝数",width:100,align:"center"},
				{field:"countDate",title:"统计日期",width:100,align:"center"}
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="addFans" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">减少粉丝数：</td>
					<td><input type="text" name="reduceFans" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">统计日期：</td>
					<td><input type="text" name="countDate" class="easyui-datebox" data-options="required:true,editable:false"></td>
				</tr>
			</table>
		</form>
	</div>
