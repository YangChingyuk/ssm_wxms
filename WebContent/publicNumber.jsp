		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				<tr>
					...
					<td><input type="text" name="public_id" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<select id="cc" class="easyui-combobox" name="public_type" style="width:150px" data-options="required:true,editable:false">   
							<option>订阅号</option>
				    		<option>服务号</option>  
				    		<option>企业号</option>
						</select>
				...
				<tr>
					...
					<td><input type="text" name="logo" class="easyui-filebox" data-options="buttonText:'选择logo'"></td>
				</tr>
				<tr>
