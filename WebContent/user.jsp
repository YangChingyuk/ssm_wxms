		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" id="file" name="photo" class="easyui-filebox" data-options="buttonText:'选择头像'"></td>
				</tr>
				<tr>
					<td class="right">所属角色：</td>
					<td>
						<select id="cc" class="easyui-combobox" name="role" style="width:150px" data-options="required:true,editable:false">   
							<option>管理员</option>
				    		<option>公众号运营员</option> 
				    		<option>营业员</option>
						</select>
					</td>
				</tr>
